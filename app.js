    ...
    const scheduleData = useMemo(() => [
        ...
        },
        {
            ...
            events: [
                ...
                { time: '10:30 AM – 01:00 PM', title: lang === 'es' ? 'Sesión de Fotos Grupales por Generación' : 'Generation Group Photo Shoot', desc: lang === 'es' ? 'Fotos profesionales tomadas por generaciones (1ra, 2da, 3ra, 4ta gen). ¡Vestir de blanco y turquesa!' : 'Professional photos taken by generation wings (1st, 2nd, 3rd, 4th gen). Wear matching white/teal attire!', location: lang === 'es' ? 'Muelle del Mar' : 'Ocean Pier' },
